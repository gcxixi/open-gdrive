...
android {
    ...
    defaultConfig {
        ...
        minSdk = 36
        targetSdk = 36
        versionCode = providers.gradleProperty("VERSION_CODE").orNull?.toInt() ?: 11
        versionName = providers.gradleProperty("VERSION_NAME").orNull ?: "0.4.4"
